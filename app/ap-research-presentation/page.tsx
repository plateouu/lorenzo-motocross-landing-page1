                    ...
                    >
                            ...
                            <div className="space-y-12 text-center p-8">
                                ...
                                <div className="flex flex-col md:flex-row gap-8 mt-12">
                                    <div className="p-6 border-4 border-black bg-yellow-400">
                                        ...
                                        <p className="text-4xl font-black uppercase">Algorithmic View Farmer</p>
                                    </div>
                        ...
                        {SLIDES[current].id === "results-3" && (
                            <div className="space-y-12 text-center p-8">
                                ...
                                <p className="text-3xl font-bold">My final finding is the loss of the creative spirit. Artists feel forced into safe, repetitive styles to avoid losing views. They feel suffocated by the pressure to follow templates. This proves that art is no longer just expression; it is becoming a high-stress Algorithmic View Farmer job. Creators are no longer focused on what they want to say, but on what the algorithm requires, leading to burnout.</p>
