            ...
            <div className="max-w-4xl mx-auto py-12">
                ...
                <article className="space-y-24 pb-48">
                    ...
                    <Section title="Key Findings" slide="10 & 11 & 12" time="8:50 - 11:50">
                        <p><strong>[SLIDE 10: RESULT 1 - THE LINGUISTIC SHIFT]</strong> My first finding revealed a profound shift in the language of content creators. In their reflections, the vocabulary of "craft" and "inspiration" is being replaced by industrial terminology like "retention rates," "evergreen assets," and "engagement metrics." This isn't just a change in words; it represents a move toward an industrial identity. <strong>Tarleton Gillespie’s</strong> theories suggest that when an algorithm becomes the curator, artists stop viewing their work as expression and start viewing it as data that must be "processed" to survive.</p>
                        
                        <p><strong>[SLIDE 11: RESULT 2 - THE EMOTION OF ERASURE]</strong> Finding two focuses on the recurring emotional theme of "erasure." Over 70% of the text I analyzed used metaphors of invisibility—phrases like "shouting into a void" or "being buried alive by the feed." This reveals that content creators feel a deep psychological burden of being "erased" by algorithmic choices. As <strong>Taina Bucher</strong> describes, the fear of the invisible is a powerful control mechanism. Artists describe a feeling of "punishment" when they take a break, as if the algorithm is a divine force that requires constant sacrifice in the form of content.</p>
                        
                        <p><strong>[SLIDE 12: RESULT 3 - THE LOSS OF THE INDIVIDUAL]</strong> My final finding is the total loss of the individual voice. The discourse showed that artists feel forced into "Formulaic Style" to avoid reach collapse. They use words like "suffocated" to describe the pressure to follow templates. <strong>Loes van Driel’s</strong> research on instability is visible here; the emotional cost of chasing a moving target is a loss of self. Content creators are no longer focused on what they want to say, but on what the algorithm wants to hear, leading to a state of permanent professional anxiety.</p>
                    </Section>
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="p-6 bg-slate-50 border-2 border-black rounded-lg">
                                        ...
                                        <p className="text-lg font-bold">"So I focused on public blogs where artists are often trying to remain professional. This means the 'panic' I found in the language is likely even more extreme in private. This limitation showed me that algorithmic control creates a culture of forced professionalism where artists must hide their stress to please the system."</p>
                                    </div>
                                    <div className="p-6 bg-slate-50 border-2 border-black rounded-lg">
                                        <p className="font-black text-blue-700 mb-2">Q7: What are the real-world implications of your findings?</p>
                                        <p className="text-lg font-bold">"So the real-world implication is the death of unique artistic voices. We are moving toward an internet where everyone uses the same 'formula' to stay visible. This leads to a loss of human originality as we all start sounding like the algorithms we are trying to please."</p>
                                    </div>
                                </div>
                            </div>
