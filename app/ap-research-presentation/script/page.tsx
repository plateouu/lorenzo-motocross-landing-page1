            ...
            <div className="max-w-4xl mx-auto py-12">
                ...
                <article className="space-y-24 pb-48">
                    ...
                    <Section title="Key Findings" slide="10 & 11 & 12" time="8:50 - 11:50">
                        ...
                        <p><strong>[SLIDE 12: ARTIST BURNOUT]</strong> My final finding is the loss of the creative spirit. Content creators are forced into safe, repetitive styles to keep their views. They feel suffocated by the pressure to follow templates. This proves that art is now a high-stress job focused on farming views. Creators only focus on what the algorithm requires, leading to total professional burnout.</p>
                    </Section>
