...
function GamePageContent() {
    ...
    useEffect(() => {
        if (gameId) {
            ...
            // Home Page view logic fallback if needed, but usually handled by /page.tsx
            if (filter) {
                if (filter === "Games") {
            ...
            <div className="flex flex-col min-h-full bg-[#0a0a0a]">
                ...
                <div className="relative w-full aspect-[21/9] md:aspect-[21/8] overflow-hidden">
                    ...
                    <div className="absolute inset-0 flex flex-col items-center justify-center p-8 text-center space-y-6">
                        ...
                        <div className="w-full max-w-md min-h-[100px] flex flex-col items-center justify-center">
                            ...
                            {/* ERROR STATE (Clean, No Emojis, No Weird Jargon) */}
                            ...
                            {/* If Error and No URL, Button is Hidden/Replaced by simple text above to be cleaner? 
                                User said "dont have two timers make it really clean".
                                The text above already shows the timer. I will just hide the button completely.
                             */}
                ...
                <div className="p-8 md:p-12">
                    <div className="flex items-center justify-between mb-8">
                        ...
                        {filter && (
                            <Link href="/" className="px-4 py-2 bg-[#1a1a1a] rounded-full text-xs font-bold text-gray-400 hover:text-white transition-colors">
                                Clear Filter
                            </Link>
                        )}
                    </div>
